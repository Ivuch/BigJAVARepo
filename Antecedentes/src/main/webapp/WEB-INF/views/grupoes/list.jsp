		...
		<table class="table">
			...
			<c:forEach items="${grupoes}" var="grupo">
				<tr>
					...
					<td>${grupo.enabled}</td>
					<td class="utilbox">
						<a title="Mostrar Grupo" alt="Mostrar Grupo" href="<c:url value="/grupoes/${grupo.id}"/>">
			...
			<tr class="footer">
				<td colspan="6">
					<span class="new">
						<a href="<c:url value="/grupoes?form"/> "><img title="Crear nuevo Grupo" src="images/add.png"
