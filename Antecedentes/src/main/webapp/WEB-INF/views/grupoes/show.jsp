...
<div version="2.0">
	...
	<div id="_title_ps_com_snoopconsulting_antecedentes_domain_Grupo_id">
		...
		<div class="quicklinks form-actions submit container">
			<span class="span1">
				<spring:url value="/grupoes/${grupo.id}" var="form_delete"/>
			...
			<span class="span1">
				<a title="Actualizar Grupo" alt="Actualizar Grupo" href="<c:url value="/grupoes/${grupo.id}?form"/>">
					<img title="Actualizar Grupo" src="/images/update.png" class="image"	alt="Actualizar Grupo" />
				</a>
			</span>
				
			<span class="span1">
				<a	title="Crear nuevo Grupo" alt="Crear nuevo Grupo" href="<c:url value="/grupoes?form"/>">
					<img title="Crear nuevo Grupo" src="/images/create.png" class="image" alt="Crear nuevo Grupo" />
				</a>
			</span>
				
			<span class="span1">
				<a title="Listado de Grupoes" alt="Listado de Grupoes" href="<c:url value="/grupoes"/> ">
					<img title="Listado de Grupoes"	src="/images/list.png" class="image"	alt="Listado de Grupoes" />
				</a>
			</span>
		</div>
	</div>
