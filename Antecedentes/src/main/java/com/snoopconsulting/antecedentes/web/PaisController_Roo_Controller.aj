...
import com.snoopconsulting.antecedentes.web.PaisController;
...
privileged aspect PaisController_Roo_Controller {
    ...
    @Autowired
    PaisRepository PaisController.paisRepository;
    ...
    public String PaisController.show(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("pais", paisRepository.findOne(id));
    ...
    public String PaisController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("paises", paisRepository.findAll(new org.springframework.data.domain.PageRequest(firstResult / sizeNo, sizeNo)).getContent());
            float nrOfPages = (float) paisRepository.count() / sizeNo;
    ...
    public String PaisController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, paisRepository.findOne(id));
        return "paises/update";
    }
