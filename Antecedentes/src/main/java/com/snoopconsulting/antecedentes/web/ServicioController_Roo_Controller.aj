...
import com.snoopconsulting.antecedentes.web.ServicioController;
...
privileged aspect ServicioController_Roo_Controller {
    ...
    public String ServicioController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
